...
namespace Demo_Wpf_TheSimpleGame.Business
{
    ...
    public class GameBusiness
    {
        ...
        public void SaveAllPlayers()
        {
            ...
            {
                if (p.Name == _playerOne.Name)
                { p.Wins = _playerOne.Wins;
                    p.Losses = _playerOne.Losses;
                    p.Ties = _playerOne.Ties;
                }
                if (p.Name == _playerTwo.Name)
                {
                    p.Wins = _playerTwo.Wins;
                    p.Losses = _playerTwo.Losses;
                    p.Ties = _playerTwo.Ties;
                }
            }
